// v5 视觉复核：正投影俯视图 + 全景 + 8 房 + 接待厅 + 入口前庭
...
const views = [
  ...
  // v5 新增：人眼高度沿主廊东望（验 4.2m 净宽 + 走廊无陈设）
  ['p9_corr_eye',    7.6,  1.62, 10.3, 29.0,  1.10, 10.3],
  // v5 新增：人眼高度沿西支廊北望圆厅（验接待厅已清空）
  ['p10_west_eye',   9.9,  1.62, 20.6,  9.4,  0.90, 10.0],
  // v5 新增：圆厅正上方俯视（验圆形石盘 + 环带，四周无家具）
  ['p11_lobby_top',  9.4, 12.0, 10.9,  9.4,  0.0, 10.8],
];
