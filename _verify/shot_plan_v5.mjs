...
const target = 'file:///' + path.resolve(here, '../平面图方案-走廊加宽版.html').replace(/\\/g, '/');
...
await page.screenshot({ path: path.resolve(here, '../_shots/plan_v5_dark.png'), fullPage: true });
await page.evaluate(() => { document.body.dataset.theme = 'light'; });
await page.waitForTimeout(400);
await page.screenshot({ path: path.resolve(here, '../_shots/plan_v5_light.png'), fullPage: true });
